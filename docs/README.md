...
- [设备绑定（Device Binding）设计](./domain/DEVICE_BINDING.md)：三端扫码绑定流程、OAuth 2.1 Token 端点、RS256 双 token、API 契约。
...
3. ADR：理解为什么采用当前边界；
4. 存储模型：理解 PostgreSQL 和 MinIO 如何承载领域对象；
5. 实施方案：理解各阶段如何交付这些能力。
