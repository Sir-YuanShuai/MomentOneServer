...
class NotificationPreference(Base):
    ...
    reminder_channel: Mapped[str] = mapped_column(String(16), default="in_app")
    habit_channel: Mapped[str] = mapped_column(String(16), default="in_app")
    security_channel: Mapped[str] = mapped_column(String(16), default="in_app")
    announcement_channel: Mapped[str] = mapped_column(String(16), default="off")
